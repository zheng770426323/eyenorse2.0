...
package com.eyenorse.zxing.view;
...
public final class ViewfinderView extends View
{
  ...
  public ViewfinderView(Context context, AttributeSet attrs)
  {
    ...
    frameColor = Color.WHITE;//resources.getColor(R.color.viewfinder_frame);
  ...
  public void onDraw(Canvas canvas)
  {
    ...
    else
    {
      ...
      canvas.drawText(
              "将条形码/二维码放入框内",
              frame.left+((BitmapDrawable)(getResources().getDrawable(R.mipmap.tiaoxinma))).getBitmap().getWidth(),
