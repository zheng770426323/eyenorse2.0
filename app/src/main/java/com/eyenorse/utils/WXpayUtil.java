...
public class WXpayUtil {
    private IWXAPI api;
    private WXpayforInfo order;
    private PayReq req;
    private Map<String,String> resultunifiedorder;
    private Context context;
    private String tradenumber;

    public WXpayUtil(Context mcontext,WXpayforInfo order,String tradenumber){//初始化微信支付
        this.order=order;
        ...
        Log.e("sIsWXAppInstall",sIsWXAppInstalledAndSupported+"");
